...
if (-not $SilentMode)
{
	...
	if (-not $form)
	{
		...
		$contextMenu.Items.Add($rebootItem)
		...
		$contextMenu.Items.Add($installIntoSMSItem)
		...
		$contextMenu.Items.Add($repairBMSItem)
		...
		$contextMenu.Items.Add($manualRepairItem)
		...
		$contextMenu.Items.Add($fixJournalItem)
...
if (-not $SilentMode)
{
	...
	if (-not $form)
	{
		...
		$RepairBMSButton.Text = "Repair BMS Service"
		$RepairBMSButton.Location = New-Object System.Drawing.Point(695, 65)
		$RepairBMSButton.Size = New-Object System.Drawing.Size(150, 30)
		$RepairBMSButton.add_Click({
				Repair-BMS
			})
